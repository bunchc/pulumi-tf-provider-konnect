module github.com/bunchc/pulumi-tf-provider-konnect/provider
...
replace (
	...
	github.com/kong/terraform-provider-konnect/shim => ./shim
)

require (
	github.com/kong/terraform-provider-konnect/shim v0.0.0
...
require (
	...
	github.com/kong/terraform-provider-konnect v0.6.2 // indirect
