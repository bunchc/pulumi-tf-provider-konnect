...
namespace Pulumi.Konnect.Outputs
{
    ...
    [OutputType]
    public sealed class GetApplicationAuthStrategyOpenidConnectConfigsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetApplicationAuthStrategyOpenidConnectConfigsOpenidConnectResult OpenidConnect;

        [OutputConstructor]
        private GetApplicationAuthStrategyOpenidConnectConfigsResult(Outputs.GetApplicationAuthStrategyOpenidConnectConfigsOpenidConnectResult openidConnect)
        {
