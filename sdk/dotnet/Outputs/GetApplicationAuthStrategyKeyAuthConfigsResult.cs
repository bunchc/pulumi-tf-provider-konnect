...
namespace Pulumi.Konnect.Outputs
{
    ...
    [OutputType]
    public sealed class GetApplicationAuthStrategyKeyAuthConfigsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetApplicationAuthStrategyKeyAuthConfigsKeyAuthResult KeyAuth;

        [OutputConstructor]
        private GetApplicationAuthStrategyKeyAuthConfigsResult(Outputs.GetApplicationAuthStrategyKeyAuthConfigsKeyAuthResult keyAuth)
        {
            KeyAuth = keyAuth;
        }
    }
