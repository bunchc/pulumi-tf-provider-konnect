...
namespace Pulumi.Konnect.Inputs
{
    ...
    public sealed class GatewayPluginOpenidConnectConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("clientJwks")]
        private InputList<Inputs.GatewayPluginOpenidConnectConfigClientJwkArgs>? _clientJwks;

        /// <summary>
        /// The JWK used for the private*key*jwt authentication.
        /// </summary>
        public InputList<Inputs.GatewayPluginOpenidConnectConfigClientJwkArgs> ClientJwks
        {
            get => _clientJwks ?? (_clientJwks = new InputList<Inputs.GatewayPluginOpenidConnectConfigClientJwkArgs>());
        ...
        private InputList<Inputs.GatewayPluginOpenidConnectConfigSessionRedisClusterNodeArgs>? _sessionRedisClusterNodes;

        /// <summary>
        /// The Redis cluster node host. Takes an array of host records, with either `ip` or `host`, and `port` values.
        /// </summary>
        public InputList<Inputs.GatewayPluginOpenidConnectConfigSessionRedisClusterNodeArgs> SessionRedisClusterNodes
        {
            get => _sessionRedisClusterNodes ?? (_sessionRedisClusterNodes = new InputList<Inputs.GatewayPluginOpenidConnectConfigSessionRedisClusterNodeArgs>());
        ...
        public GatewayPluginOpenidConnectConfigArgs()
        {
        }
        public static new GatewayPluginOpenidConnectConfigArgs Empty => new GatewayPluginOpenidConnectConfigArgs();
    }
}
