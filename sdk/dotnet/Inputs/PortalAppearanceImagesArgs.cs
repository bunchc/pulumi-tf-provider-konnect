...
namespace Pulumi.Konnect.Inputs
{
    ...
    public sealed class PortalAppearanceImagesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("catalogCover")]
        public Input<Inputs.PortalAppearanceImagesCatalogCoverArgs>? CatalogCover { get; set; }
        ...
        /// </summary>
        [Input("favicon")]
        public Input<Inputs.PortalAppearanceImagesFaviconArgs>? Favicon { get; set; }

        /// <summary>
        /// The image data to upload, along with an optional filename. Images must be a data URL with binary image data in base 64 format. See https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics*of*HTTP/Data_URLs.
        /// </summary>
        [Input("logo")]
        public Input<Inputs.PortalAppearanceImagesLogoArgs>? Logo { get; set; }

        public PortalAppearanceImagesArgs()
        {
        }
        public static new PortalAppearanceImagesArgs Empty => new PortalAppearanceImagesArgs();
    }
}
