...
namespace Pulumi.Konnect.Inputs
{
    ...
    public sealed class GatewayPluginSamlConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.GatewayPluginSamlConfigSessionRedisClusterNodeGetArgs>? _sessionRedisClusterNodes;

        /// <summary>
        /// The Redis cluster node host. Takes an array of host records, with either `ip` or `host`, and `port` values.
        /// </summary>
        public InputList<Inputs.GatewayPluginSamlConfigSessionRedisClusterNodeGetArgs> SessionRedisClusterNodes
        {
            get => _sessionRedisClusterNodes ?? (_sessionRedisClusterNodes = new InputList<Inputs.GatewayPluginSamlConfigSessionRedisClusterNodeGetArgs>());
        ...
        public GatewayPluginSamlConfigGetArgs()
        {
        }
        public static new GatewayPluginSamlConfigGetArgs Empty => new GatewayPluginSamlConfigGetArgs();
    }
}
