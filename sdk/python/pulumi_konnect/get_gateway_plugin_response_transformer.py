...
__all__ = [
    'GetGatewayPluginResponseTransformerResult',
    'AwaitableGetGatewayPluginResponseTransformerResult',
    'get_gateway_plugin_response_transformer',
    'get_gateway_plugin_response_transformer_output',
]

@pulumi.output_type
class GetGatewayPluginResponseTransformerResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginResponseTransformerConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginResponseTransformerConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginResponseTransformerConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginResponseTransformerRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginResponseTransformerServiceResult':
...
class AwaitableGetGatewayPluginResponseTransformerResult(GetGatewayPluginResponseTransformerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginResponseTransformerResult(
            config=self.config,
...
def get_gateway_plugin_response_transformer(control_plane_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginResponseTransformerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginResponseTransformer:getGatewayPluginResponseTransformer', __args__, opts=opts, typ=GetGatewayPluginResponseTransformerResult).value

    return AwaitableGetGatewayPluginResponseTransformerResult(
...
@_utilities.lift_output_func(get_gateway_plugin_response_transformer)
def get_gateway_plugin_response_transformer_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginResponseTransformerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
