...
__all__ = [
    'GetGatewayPluginJqResult',
    'AwaitableGetGatewayPluginJqResult',
    'get_gateway_plugin_jq',
    'get_gateway_plugin_jq_output',
]

@pulumi.output_type
class GetGatewayPluginJqResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginJqConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginJqConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginJqConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginJqRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginJqServiceResult':
...
class AwaitableGetGatewayPluginJqResult(GetGatewayPluginJqResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginJqResult(
            config=self.config,
...
def get_gateway_plugin_jq(control_plane_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginJqResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginJq:getGatewayPluginJq', __args__, opts=opts, typ=GetGatewayPluginJqResult).value

    return AwaitableGetGatewayPluginJqResult(
...
@_utilities.lift_output_func(get_gateway_plugin_jq)
def get_gateway_plugin_jq_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginJqResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
