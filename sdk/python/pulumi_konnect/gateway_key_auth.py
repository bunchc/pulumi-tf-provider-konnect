...
__all__ = ['GatewayKeyAuthArgs', 'GatewayKeyAuth']

@pulumi.input_type
class GatewayKeyAuthArgs:
...
@pulumi.input_type
class _GatewayKeyAuthState:
    def __init__(__self__, *,
                 consumer: Optional[pulumi.Input['GatewayKeyAuthConsumerArgs']] = None,
    ...
    @property
    @pulumi.getter
    def consumer(self) -> Optional[pulumi.Input['GatewayKeyAuthConsumerArgs']]:
        return pulumi.get(self, "consumer")

    @consumer.setter
    def consumer(self, value: Optional[pulumi.Input['GatewayKeyAuthConsumerArgs']]):
...
class GatewayKeyAuth(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GatewayKeyAuthArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayKeyAuthArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayKeyAuthArgs.__new__(GatewayKeyAuthArgs)
        ...
        super(GatewayKeyAuth, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            consumer: Optional[pulumi.Input[pulumi.InputType['GatewayKeyAuthConsumerArgs']]] = None,
            consumer_id: Optional[pulumi.Input[str]] = None,
            control_plane_id: Optional[pulumi.Input[str]] = None,
            created_at: Optional[pulumi.Input[int]] = None,
            key: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'GatewayKeyAuth':
        """
        ...
        __props__ = _GatewayKeyAuthState.__new__(_GatewayKeyAuthState)
        ...
        __props__.__dict__["key"] = key
        __props__.__dict__["tags"] = tags
        return GatewayKeyAuth(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def consumer(self) -> pulumi.Output['outputs.GatewayKeyAuthConsumer']:
        return pulumi.get(self, "consumer")
