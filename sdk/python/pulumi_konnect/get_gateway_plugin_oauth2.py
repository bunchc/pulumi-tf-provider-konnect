...
__all__ = [
    'GetGatewayPluginOauth2Result',
    'AwaitableGetGatewayPluginOauth2Result',
    'get_gateway_plugin_oauth2',
    'get_gateway_plugin_oauth2_output',
]

@pulumi.output_type
class GetGatewayPluginOauth2Result:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginOauth2ConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginOauth2ConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginOauth2ConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginOauth2RouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginOauth2ServiceResult':
...
class AwaitableGetGatewayPluginOauth2Result(GetGatewayPluginOauth2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginOauth2Result(
            config=self.config,
...
def get_gateway_plugin_oauth2(control_plane_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginOauth2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginOauth2:getGatewayPluginOauth2', __args__, opts=opts, typ=GetGatewayPluginOauth2Result).value

    return AwaitableGetGatewayPluginOauth2Result(
...
@_utilities.lift_output_func(get_gateway_plugin_oauth2)
def get_gateway_plugin_oauth2_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginOauth2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
