...
__all__ = [
    'GetGatewayPluginJwtResult',
    'AwaitableGetGatewayPluginJwtResult',
    'get_gateway_plugin_jwt',
    'get_gateway_plugin_jwt_output',
]

@pulumi.output_type
class GetGatewayPluginJwtResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginJwtConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginJwtConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginJwtConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginJwtRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginJwtServiceResult':
...
class AwaitableGetGatewayPluginJwtResult(GetGatewayPluginJwtResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginJwtResult(
            config=self.config,
...
def get_gateway_plugin_jwt(control_plane_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginJwtResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginJwt:getGatewayPluginJwt', __args__, opts=opts, typ=GetGatewayPluginJwtResult).value

    return AwaitableGetGatewayPluginJwtResult(
...
@_utilities.lift_output_func(get_gateway_plugin_jwt)
def get_gateway_plugin_jwt_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginJwtResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
