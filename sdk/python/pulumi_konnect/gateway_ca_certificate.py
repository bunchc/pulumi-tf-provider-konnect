...
__all__ = ['GatewayCaCertificateArgs', 'GatewayCaCertificate']

@pulumi.input_type
class GatewayCaCertificateArgs:
    def __init__(__self__, *,
                 control_plane_id: pulumi.Input[str],
                 cert: Optional[pulumi.Input[str]] = None,
                 cert_digest: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] cert: PEM-encoded public certificate of the CA.
        :param pulumi.Input[str] cert_digest: SHA256 hex digest of the public certificate. This field is read-only and it cannot be set by the caller, the value is automatically computed.
        ...
        if cert_digest is not None:
            pulumi.set(__self__, "cert_digest", cert_digest)
        if tags is not None:
    ...
    @property
    @pulumi.getter(name="certDigest")
    def cert_digest(self) -> Optional[pulumi.Input[str]]:
        """
        ...
        """
        return pulumi.get(self, "cert_digest")

    @cert_digest.setter
    def cert_digest(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "cert_digest", value)
...
@pulumi.input_type
class _GatewayCaCertificateState:
    def __init__(__self__, *,
                 cert: Optional[pulumi.Input[str]] = None,
                 cert_digest: Optional[pulumi.Input[str]] = None,
...
class GatewayCaCertificate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GatewayCaCertificateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayCaCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayCaCertificateArgs.__new__(GatewayCaCertificateArgs)

            __props__.__dict__["cert"] = cert
            __props__.__dict__["cert_digest"] = cert_digest
        ...
        super(GatewayCaCertificate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            created_at: Optional[pulumi.Input[int]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            updated_at: Optional[pulumi.Input[int]] = None) -> 'GatewayCaCertificate':
        """
        ...
        __props__ = _GatewayCaCertificateState.__new__(_GatewayCaCertificateState)
        ...
        return GatewayCaCertificate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="certDigest")
    def cert_digest(self) -> pulumi.Output[str]:
        """
        SHA256 hex digest of the public certificate. This field is read-only and it cannot be set by the caller, the value is automatically computed.
        """
        return pulumi.get(self, "cert_digest")
