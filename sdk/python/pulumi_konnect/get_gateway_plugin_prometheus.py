...
__all__ = [
    'GetGatewayPluginPrometheusResult',
    'AwaitableGetGatewayPluginPrometheusResult',
    'get_gateway_plugin_prometheus',
    'get_gateway_plugin_prometheus_output',
]

@pulumi.output_type
class GetGatewayPluginPrometheusResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginPrometheusConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginPrometheusConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginPrometheusConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginPrometheusRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginPrometheusServiceResult':
...
class AwaitableGetGatewayPluginPrometheusResult(GetGatewayPluginPrometheusResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginPrometheusResult(
            config=self.config,
...
def get_gateway_plugin_prometheus(control_plane_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginPrometheusResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginPrometheus:getGatewayPluginPrometheus', __args__, opts=opts, typ=GetGatewayPluginPrometheusResult).value

    return AwaitableGetGatewayPluginPrometheusResult(
...
@_utilities.lift_output_func(get_gateway_plugin_prometheus)
def get_gateway_plugin_prometheus_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginPrometheusResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
