...
__all__ = ['GatewayAclArgs', 'GatewayAcl']

@pulumi.input_type
class GatewayAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] group: Requires replacement if changed.
...
@pulumi.input_type
class _GatewayAclState:
    def __init__(__self__, *,
                 consumer: Optional[pulumi.Input['GatewayAclConsumerArgs']] = None,
    ...
    @property
    @pulumi.getter
    def consumer(self) -> Optional[pulumi.Input['GatewayAclConsumerArgs']]:
        return pulumi.get(self, "consumer")

    @consumer.setter
    def consumer(self, value: Optional[pulumi.Input['GatewayAclConsumerArgs']]):
...
class GatewayAcl(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GatewayAclArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayAclArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayAclArgs.__new__(GatewayAclArgs)
        ...
        super(GatewayAcl, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            consumer: Optional[pulumi.Input[pulumi.InputType['GatewayAclConsumerArgs']]] = None,
            consumer_id: Optional[pulumi.Input[str]] = None,
            control_plane_id: Optional[pulumi.Input[str]] = None,
            created_at: Optional[pulumi.Input[int]] = None,
            group: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'GatewayAcl':
        """
        ...
        __props__ = _GatewayAclState.__new__(_GatewayAclState)
        ...
        __props__.__dict__["group"] = group
        __props__.__dict__["tags"] = tags
        return GatewayAcl(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def consumer(self) -> pulumi.Output['outputs.GatewayAclConsumer']:
        return pulumi.get(self, "consumer")
