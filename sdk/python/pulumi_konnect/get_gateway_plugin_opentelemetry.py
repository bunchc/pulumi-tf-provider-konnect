...
__all__ = [
    'GetGatewayPluginOpentelemetryResult',
    'AwaitableGetGatewayPluginOpentelemetryResult',
    'get_gateway_plugin_opentelemetry',
    'get_gateway_plugin_opentelemetry_output',
]

@pulumi.output_type
class GetGatewayPluginOpentelemetryResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginOpentelemetryConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginOpentelemetryConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginOpentelemetryConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginOpentelemetryRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginOpentelemetryServiceResult':
...
class AwaitableGetGatewayPluginOpentelemetryResult(GetGatewayPluginOpentelemetryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginOpentelemetryResult(
            config=self.config,
...
def get_gateway_plugin_opentelemetry(control_plane_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginOpentelemetryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginOpentelemetry:getGatewayPluginOpentelemetry', __args__, opts=opts, typ=GetGatewayPluginOpentelemetryResult).value

    return AwaitableGetGatewayPluginOpentelemetryResult(
...
@_utilities.lift_output_func(get_gateway_plugin_opentelemetry)
def get_gateway_plugin_opentelemetry_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginOpentelemetryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
