...
__all__ = [
    'GetGatewayPluginPreFunctionResult',
    'AwaitableGetGatewayPluginPreFunctionResult',
    'get_gateway_plugin_pre_function',
    'get_gateway_plugin_pre_function_output',
]

@pulumi.output_type
class GetGatewayPluginPreFunctionResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginPreFunctionConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginPreFunctionConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginPreFunctionConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginPreFunctionRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginPreFunctionServiceResult':
...
class AwaitableGetGatewayPluginPreFunctionResult(GetGatewayPluginPreFunctionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginPreFunctionResult(
            config=self.config,
...
def get_gateway_plugin_pre_function(control_plane_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginPreFunctionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginPreFunction:getGatewayPluginPreFunction', __args__, opts=opts, typ=GetGatewayPluginPreFunctionResult).value

    return AwaitableGetGatewayPluginPreFunctionResult(
...
@_utilities.lift_output_func(get_gateway_plugin_pre_function)
def get_gateway_plugin_pre_function_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginPreFunctionResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
