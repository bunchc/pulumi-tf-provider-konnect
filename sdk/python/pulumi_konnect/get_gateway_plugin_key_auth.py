...
__all__ = [
    'GetGatewayPluginKeyAuthResult',
    'AwaitableGetGatewayPluginKeyAuthResult',
    'get_gateway_plugin_key_auth',
    'get_gateway_plugin_key_auth_output',
]

@pulumi.output_type
class GetGatewayPluginKeyAuthResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginKeyAuthConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginKeyAuthConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginKeyAuthConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginKeyAuthRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginKeyAuthServiceResult':
...
class AwaitableGetGatewayPluginKeyAuthResult(GetGatewayPluginKeyAuthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginKeyAuthResult(
            config=self.config,
...
def get_gateway_plugin_key_auth(control_plane_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginKeyAuthResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginKeyAuth:getGatewayPluginKeyAuth', __args__, opts=opts, typ=GetGatewayPluginKeyAuthResult).value

    return AwaitableGetGatewayPluginKeyAuthResult(
...
@_utilities.lift_output_func(get_gateway_plugin_key_auth)
def get_gateway_plugin_key_auth_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginKeyAuthResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
