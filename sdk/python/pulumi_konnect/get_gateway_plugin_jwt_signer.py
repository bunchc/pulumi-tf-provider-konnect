...
__all__ = [
    'GetGatewayPluginJwtSignerResult',
    'AwaitableGetGatewayPluginJwtSignerResult',
    'get_gateway_plugin_jwt_signer',
    'get_gateway_plugin_jwt_signer_output',
]

@pulumi.output_type
class GetGatewayPluginJwtSignerResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginJwtSignerConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginJwtSignerConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginJwtSignerConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginJwtSignerRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginJwtSignerServiceResult':
...
class AwaitableGetGatewayPluginJwtSignerResult(GetGatewayPluginJwtSignerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginJwtSignerResult(
            config=self.config,
...
def get_gateway_plugin_jwt_signer(control_plane_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginJwtSignerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginJwtSigner:getGatewayPluginJwtSigner', __args__, opts=opts, typ=GetGatewayPluginJwtSignerResult).value

    return AwaitableGetGatewayPluginJwtSignerResult(
...
@_utilities.lift_output_func(get_gateway_plugin_jwt_signer)
def get_gateway_plugin_jwt_signer_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginJwtSignerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
