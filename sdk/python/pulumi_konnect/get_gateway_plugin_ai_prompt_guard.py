...
__all__ = [
    'GetGatewayPluginAiPromptGuardResult',
    'AwaitableGetGatewayPluginAiPromptGuardResult',
    'get_gateway_plugin_ai_prompt_guard',
    'get_gateway_plugin_ai_prompt_guard_output',
]

@pulumi.output_type
class GetGatewayPluginAiPromptGuardResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAiPromptGuardConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAiPromptGuardConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAiPromptGuardConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAiPromptGuardRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAiPromptGuardServiceResult':
...
class AwaitableGetGatewayPluginAiPromptGuardResult(GetGatewayPluginAiPromptGuardResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAiPromptGuardResult(
            config=self.config,
...
def get_gateway_plugin_ai_prompt_guard(control_plane_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAiPromptGuardResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAiPromptGuard:getGatewayPluginAiPromptGuard', __args__, opts=opts, typ=GetGatewayPluginAiPromptGuardResult).value

    return AwaitableGetGatewayPluginAiPromptGuardResult(
...
@_utilities.lift_output_func(get_gateway_plugin_ai_prompt_guard)
def get_gateway_plugin_ai_prompt_guard_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAiPromptGuardResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
