...
__all__ = [
    'GetGatewayPluginAclResult',
    'AwaitableGetGatewayPluginAclResult',
    'get_gateway_plugin_acl',
    'get_gateway_plugin_acl_output',
]

@pulumi.output_type
class GetGatewayPluginAclResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAclConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAclConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAclConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAclRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAclServiceResult':
...
class AwaitableGetGatewayPluginAclResult(GetGatewayPluginAclResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAclResult(
            config=self.config,
...
def get_gateway_plugin_acl(control_plane_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAclResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAcl:getGatewayPluginAcl', __args__, opts=opts, typ=GetGatewayPluginAclResult).value

    return AwaitableGetGatewayPluginAclResult(
...
@_utilities.lift_output_func(get_gateway_plugin_acl)
def get_gateway_plugin_acl_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAclResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
