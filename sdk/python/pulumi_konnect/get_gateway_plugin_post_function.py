...
__all__ = [
    'GetGatewayPluginPostFunctionResult',
    'AwaitableGetGatewayPluginPostFunctionResult',
    'get_gateway_plugin_post_function',
    'get_gateway_plugin_post_function_output',
]

@pulumi.output_type
class GetGatewayPluginPostFunctionResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginPostFunctionConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginPostFunctionConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginPostFunctionConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginPostFunctionRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginPostFunctionServiceResult':
...
class AwaitableGetGatewayPluginPostFunctionResult(GetGatewayPluginPostFunctionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginPostFunctionResult(
            config=self.config,
...
def get_gateway_plugin_post_function(control_plane_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginPostFunctionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginPostFunction:getGatewayPluginPostFunction', __args__, opts=opts, typ=GetGatewayPluginPostFunctionResult).value

    return AwaitableGetGatewayPluginPostFunctionResult(
...
@_utilities.lift_output_func(get_gateway_plugin_post_function)
def get_gateway_plugin_post_function_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginPostFunctionResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
