...
__all__ = [
    'GetGatewayPluginExitTransformerResult',
    'AwaitableGetGatewayPluginExitTransformerResult',
    'get_gateway_plugin_exit_transformer',
    'get_gateway_plugin_exit_transformer_output',
]

@pulumi.output_type
class GetGatewayPluginExitTransformerResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginExitTransformerConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginExitTransformerConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginExitTransformerConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginExitTransformerRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginExitTransformerServiceResult':
...
class AwaitableGetGatewayPluginExitTransformerResult(GetGatewayPluginExitTransformerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginExitTransformerResult(
            config=self.config,
...
def get_gateway_plugin_exit_transformer(control_plane_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginExitTransformerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginExitTransformer:getGatewayPluginExitTransformer', __args__, opts=opts, typ=GetGatewayPluginExitTransformerResult).value

    return AwaitableGetGatewayPluginExitTransformerResult(
...
@_utilities.lift_output_func(get_gateway_plugin_exit_transformer)
def get_gateway_plugin_exit_transformer_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginExitTransformerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
