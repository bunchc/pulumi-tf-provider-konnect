...
__all__ = [
    'GetGatewayPluginStatsdResult',
    'AwaitableGetGatewayPluginStatsdResult',
    'get_gateway_plugin_statsd',
    'get_gateway_plugin_statsd_output',
]

@pulumi.output_type
class GetGatewayPluginStatsdResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginStatsdConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginStatsdConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginStatsdConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginStatsdRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginStatsdServiceResult':
...
class AwaitableGetGatewayPluginStatsdResult(GetGatewayPluginStatsdResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginStatsdResult(
            config=self.config,
...
def get_gateway_plugin_statsd(control_plane_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginStatsdResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginStatsd:getGatewayPluginStatsd', __args__, opts=opts, typ=GetGatewayPluginStatsdResult).value

    return AwaitableGetGatewayPluginStatsdResult(
...
@_utilities.lift_output_func(get_gateway_plugin_statsd)
def get_gateway_plugin_statsd_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginStatsdResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
