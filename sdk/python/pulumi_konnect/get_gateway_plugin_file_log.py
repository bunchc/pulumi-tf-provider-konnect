...
__all__ = [
    'GetGatewayPluginFileLogResult',
    'AwaitableGetGatewayPluginFileLogResult',
    'get_gateway_plugin_file_log',
    'get_gateway_plugin_file_log_output',
]

@pulumi.output_type
class GetGatewayPluginFileLogResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginFileLogConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginFileLogConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginFileLogConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginFileLogRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginFileLogServiceResult':
...
class AwaitableGetGatewayPluginFileLogResult(GetGatewayPluginFileLogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginFileLogResult(
            config=self.config,
...
def get_gateway_plugin_file_log(control_plane_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginFileLogResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginFileLog:getGatewayPluginFileLog', __args__, opts=opts, typ=GetGatewayPluginFileLogResult).value

    return AwaitableGetGatewayPluginFileLogResult(
...
@_utilities.lift_output_func(get_gateway_plugin_file_log)
def get_gateway_plugin_file_log_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginFileLogResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
