...
__all__ = [
    'GetGatewayPluginRequestTransformerResult',
    'AwaitableGetGatewayPluginRequestTransformerResult',
    'get_gateway_plugin_request_transformer',
    'get_gateway_plugin_request_transformer_output',
]

@pulumi.output_type
class GetGatewayPluginRequestTransformerResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginRequestTransformerConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginRequestTransformerConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginRequestTransformerConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginRequestTransformerRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginRequestTransformerServiceResult':
...
class AwaitableGetGatewayPluginRequestTransformerResult(GetGatewayPluginRequestTransformerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginRequestTransformerResult(
            config=self.config,
...
def get_gateway_plugin_request_transformer(control_plane_id: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginRequestTransformerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginRequestTransformer:getGatewayPluginRequestTransformer', __args__, opts=opts, typ=GetGatewayPluginRequestTransformerResult).value

    return AwaitableGetGatewayPluginRequestTransformerResult(
...
@_utilities.lift_output_func(get_gateway_plugin_request_transformer)
def get_gateway_plugin_request_transformer_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginRequestTransformerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
