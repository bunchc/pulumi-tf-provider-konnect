...
__all__ = [
    'GetGatewayPluginProxyCacheResult',
    'AwaitableGetGatewayPluginProxyCacheResult',
    'get_gateway_plugin_proxy_cache',
    'get_gateway_plugin_proxy_cache_output',
]

@pulumi.output_type
class GetGatewayPluginProxyCacheResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginProxyCacheConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginProxyCacheConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginProxyCacheConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginProxyCacheRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginProxyCacheServiceResult':
...
class AwaitableGetGatewayPluginProxyCacheResult(GetGatewayPluginProxyCacheResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginProxyCacheResult(
            config=self.config,
...
def get_gateway_plugin_proxy_cache(control_plane_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginProxyCacheResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginProxyCache:getGatewayPluginProxyCache', __args__, opts=opts, typ=GetGatewayPluginProxyCacheResult).value

    return AwaitableGetGatewayPluginProxyCacheResult(
...
@_utilities.lift_output_func(get_gateway_plugin_proxy_cache)
def get_gateway_plugin_proxy_cache_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginProxyCacheResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
