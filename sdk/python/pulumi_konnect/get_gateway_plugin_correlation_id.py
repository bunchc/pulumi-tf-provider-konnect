...
__all__ = [
    'GetGatewayPluginCorrelationIdResult',
    'AwaitableGetGatewayPluginCorrelationIdResult',
    'get_gateway_plugin_correlation_id',
    'get_gateway_plugin_correlation_id_output',
]

@pulumi.output_type
class GetGatewayPluginCorrelationIdResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginCorrelationIdConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginCorrelationIdConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginCorrelationIdConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginCorrelationIdRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginCorrelationIdServiceResult':
...
class AwaitableGetGatewayPluginCorrelationIdResult(GetGatewayPluginCorrelationIdResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginCorrelationIdResult(
            config=self.config,
...
def get_gateway_plugin_correlation_id(control_plane_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginCorrelationIdResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginCorrelationId:getGatewayPluginCorrelationId', __args__, opts=opts, typ=GetGatewayPluginCorrelationIdResult).value

    return AwaitableGetGatewayPluginCorrelationIdResult(
...
@_utilities.lift_output_func(get_gateway_plugin_correlation_id)
def get_gateway_plugin_correlation_id_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginCorrelationIdResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
