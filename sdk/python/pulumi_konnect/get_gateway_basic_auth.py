...
__all__ = [
    'GetGatewayBasicAuthResult',
    'AwaitableGetGatewayBasicAuthResult',
    'get_gateway_basic_auth',
    'get_gateway_basic_auth_output',
]

@pulumi.output_type
class GetGatewayBasicAuthResult:
    """
    A collection of values returned by getGatewayBasicAuth.
    """
    def __init__(__self__, consumer=None, consumer_id=None, control_plane_id=None, created_at=None, id=None, tags=None, username=None):
    ...
    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayBasicAuthConsumerResult':
...
class AwaitableGetGatewayBasicAuthResult(GetGatewayBasicAuthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayBasicAuthResult(
...
def get_gateway_basic_auth(consumer_id: Optional[str] = None,
                           control_plane_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayBasicAuthResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayBasicAuth:getGatewayBasicAuth', __args__, opts=opts, typ=GetGatewayBasicAuthResult).value

    return AwaitableGetGatewayBasicAuthResult(
...
@_utilities.lift_output_func(get_gateway_basic_auth)
def get_gateway_basic_auth_output(consumer_id: Optional[pulumi.Input[str]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayBasicAuthResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
