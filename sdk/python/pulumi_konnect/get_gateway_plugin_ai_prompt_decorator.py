...
__all__ = [
    'GetGatewayPluginAiPromptDecoratorResult',
    'AwaitableGetGatewayPluginAiPromptDecoratorResult',
    'get_gateway_plugin_ai_prompt_decorator',
    'get_gateway_plugin_ai_prompt_decorator_output',
]

@pulumi.output_type
class GetGatewayPluginAiPromptDecoratorResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAiPromptDecoratorConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAiPromptDecoratorConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAiPromptDecoratorConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAiPromptDecoratorRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAiPromptDecoratorServiceResult':
...
class AwaitableGetGatewayPluginAiPromptDecoratorResult(GetGatewayPluginAiPromptDecoratorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAiPromptDecoratorResult(
            config=self.config,
...
def get_gateway_plugin_ai_prompt_decorator(control_plane_id: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAiPromptDecoratorResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAiPromptDecorator:getGatewayPluginAiPromptDecorator', __args__, opts=opts, typ=GetGatewayPluginAiPromptDecoratorResult).value

    return AwaitableGetGatewayPluginAiPromptDecoratorResult(
...
@_utilities.lift_output_func(get_gateway_plugin_ai_prompt_decorator)
def get_gateway_plugin_ai_prompt_decorator_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAiPromptDecoratorResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
