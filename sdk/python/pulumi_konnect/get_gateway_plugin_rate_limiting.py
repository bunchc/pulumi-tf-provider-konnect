...
__all__ = [
    'GetGatewayPluginRateLimitingResult',
    'AwaitableGetGatewayPluginRateLimitingResult',
    'get_gateway_plugin_rate_limiting',
    'get_gateway_plugin_rate_limiting_output',
]

@pulumi.output_type
class GetGatewayPluginRateLimitingResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginRateLimitingConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginRateLimitingConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginRateLimitingConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginRateLimitingRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginRateLimitingServiceResult':
...
class AwaitableGetGatewayPluginRateLimitingResult(GetGatewayPluginRateLimitingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginRateLimitingResult(
            config=self.config,
...
def get_gateway_plugin_rate_limiting(control_plane_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginRateLimitingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginRateLimiting:getGatewayPluginRateLimiting', __args__, opts=opts, typ=GetGatewayPluginRateLimitingResult).value

    return AwaitableGetGatewayPluginRateLimitingResult(
...
@_utilities.lift_output_func(get_gateway_plugin_rate_limiting)
def get_gateway_plugin_rate_limiting_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginRateLimitingResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
