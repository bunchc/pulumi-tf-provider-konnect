...
__all__ = [
    'GetGatewayPluginBasicAuthResult',
    'AwaitableGetGatewayPluginBasicAuthResult',
    'get_gateway_plugin_basic_auth',
    'get_gateway_plugin_basic_auth_output',
]

@pulumi.output_type
class GetGatewayPluginBasicAuthResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginBasicAuthConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginBasicAuthConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginBasicAuthConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginBasicAuthRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginBasicAuthServiceResult':
...
class AwaitableGetGatewayPluginBasicAuthResult(GetGatewayPluginBasicAuthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginBasicAuthResult(
            config=self.config,
...
def get_gateway_plugin_basic_auth(control_plane_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginBasicAuthResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginBasicAuth:getGatewayPluginBasicAuth', __args__, opts=opts, typ=GetGatewayPluginBasicAuthResult).value

    return AwaitableGetGatewayPluginBasicAuthResult(
...
@_utilities.lift_output_func(get_gateway_plugin_basic_auth)
def get_gateway_plugin_basic_auth_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginBasicAuthResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
