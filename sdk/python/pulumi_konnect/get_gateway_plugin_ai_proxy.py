...
__all__ = [
    'GetGatewayPluginAiProxyResult',
    'AwaitableGetGatewayPluginAiProxyResult',
    'get_gateway_plugin_ai_proxy',
    'get_gateway_plugin_ai_proxy_output',
]

@pulumi.output_type
class GetGatewayPluginAiProxyResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAiProxyConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAiProxyConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAiProxyConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAiProxyRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAiProxyServiceResult':
...
class AwaitableGetGatewayPluginAiProxyResult(GetGatewayPluginAiProxyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAiProxyResult(
            config=self.config,
...
def get_gateway_plugin_ai_proxy(control_plane_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAiProxyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAiProxy:getGatewayPluginAiProxy', __args__, opts=opts, typ=GetGatewayPluginAiProxyResult).value

    return AwaitableGetGatewayPluginAiProxyResult(
...
@_utilities.lift_output_func(get_gateway_plugin_ai_proxy)
def get_gateway_plugin_ai_proxy_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAiProxyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
