...
__all__ = [
    'GetGatewayPluginAiPromptTemplateResult',
    'AwaitableGetGatewayPluginAiPromptTemplateResult',
    'get_gateway_plugin_ai_prompt_template',
    'get_gateway_plugin_ai_prompt_template_output',
]

@pulumi.output_type
class GetGatewayPluginAiPromptTemplateResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAiPromptTemplateConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAiPromptTemplateConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAiPromptTemplateConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAiPromptTemplateRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAiPromptTemplateServiceResult':
...
class AwaitableGetGatewayPluginAiPromptTemplateResult(GetGatewayPluginAiPromptTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAiPromptTemplateResult(
            config=self.config,
...
def get_gateway_plugin_ai_prompt_template(control_plane_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAiPromptTemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAiPromptTemplate:getGatewayPluginAiPromptTemplate', __args__, opts=opts, typ=GetGatewayPluginAiPromptTemplateResult).value

    return AwaitableGetGatewayPluginAiPromptTemplateResult(
...
@_utilities.lift_output_func(get_gateway_plugin_ai_prompt_template)
def get_gateway_plugin_ai_prompt_template_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAiPromptTemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
