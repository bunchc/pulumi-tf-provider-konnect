...
__all__ = [
    'GetGatewayPluginAwsLambdaResult',
    'AwaitableGetGatewayPluginAwsLambdaResult',
    'get_gateway_plugin_aws_lambda',
    'get_gateway_plugin_aws_lambda_output',
]

@pulumi.output_type
class GetGatewayPluginAwsLambdaResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginAwsLambdaConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginAwsLambdaConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginAwsLambdaConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginAwsLambdaRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginAwsLambdaServiceResult':
...
class AwaitableGetGatewayPluginAwsLambdaResult(GetGatewayPluginAwsLambdaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginAwsLambdaResult(
            config=self.config,
...
def get_gateway_plugin_aws_lambda(control_plane_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginAwsLambdaResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginAwsLambda:getGatewayPluginAwsLambda', __args__, opts=opts, typ=GetGatewayPluginAwsLambdaResult).value

    return AwaitableGetGatewayPluginAwsLambdaResult(
...
@_utilities.lift_output_func(get_gateway_plugin_aws_lambda)
def get_gateway_plugin_aws_lambda_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginAwsLambdaResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
