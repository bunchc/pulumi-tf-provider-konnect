...
__all__ = [
    'GetGatewayPluginResponseTransformerAdvancedResult',
    'AwaitableGetGatewayPluginResponseTransformerAdvancedResult',
    'get_gateway_plugin_response_transformer_advanced',
    'get_gateway_plugin_response_transformer_advanced_output',
]

@pulumi.output_type
class GetGatewayPluginResponseTransformerAdvancedResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginResponseTransformerAdvancedConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginResponseTransformerAdvancedConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginResponseTransformerAdvancedConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginResponseTransformerAdvancedRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginResponseTransformerAdvancedServiceResult':
...
class AwaitableGetGatewayPluginResponseTransformerAdvancedResult(GetGatewayPluginResponseTransformerAdvancedResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginResponseTransformerAdvancedResult(
            config=self.config,
...
def get_gateway_plugin_response_transformer_advanced(control_plane_id: Optional[str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginResponseTransformerAdvancedResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginResponseTransformerAdvanced:getGatewayPluginResponseTransformerAdvanced', __args__, opts=opts, typ=GetGatewayPluginResponseTransformerAdvancedResult).value

    return AwaitableGetGatewayPluginResponseTransformerAdvancedResult(
...
@_utilities.lift_output_func(get_gateway_plugin_response_transformer_advanced)
def get_gateway_plugin_response_transformer_advanced_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginResponseTransformerAdvancedResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
