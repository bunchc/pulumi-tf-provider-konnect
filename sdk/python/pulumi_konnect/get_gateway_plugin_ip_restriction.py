...
__all__ = [
    'GetGatewayPluginIpRestrictionResult',
    'AwaitableGetGatewayPluginIpRestrictionResult',
    'get_gateway_plugin_ip_restriction',
    'get_gateway_plugin_ip_restriction_output',
]

@pulumi.output_type
class GetGatewayPluginIpRestrictionResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginIpRestrictionConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginIpRestrictionConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginIpRestrictionConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginIpRestrictionRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginIpRestrictionServiceResult':
...
class AwaitableGetGatewayPluginIpRestrictionResult(GetGatewayPluginIpRestrictionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginIpRestrictionResult(
            config=self.config,
...
def get_gateway_plugin_ip_restriction(control_plane_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginIpRestrictionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginIpRestriction:getGatewayPluginIpRestriction', __args__, opts=opts, typ=GetGatewayPluginIpRestrictionResult).value

    return AwaitableGetGatewayPluginIpRestrictionResult(
...
@_utilities.lift_output_func(get_gateway_plugin_ip_restriction)
def get_gateway_plugin_ip_restriction_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginIpRestrictionResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
