...
__all__ = ['GatewayConsumerArgs', 'GatewayConsumer']

@pulumi.input_type
class GatewayConsumerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] custom_id: Field for storing an existing unique ID for the Consumer - useful for mapping Kong with users in your existing database. You must send either this field or `username` with the request.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: An optional set of strings associated with the Consumer for grouping and filtering.
        :param pulumi.Input[str] username: The unique username of the Consumer. You must send either this field or `custom_id` with the request.
        """
...
class GatewayConsumer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GatewayConsumerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayConsumerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayConsumerArgs.__new__(GatewayConsumerArgs)
        ...
        super(GatewayConsumer, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            updated_at: Optional[pulumi.Input[int]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'GatewayConsumer':
        """
        ...
        __props__ = _GatewayConsumerState.__new__(_GatewayConsumerState)
        ...
        __props__.__dict__["username"] = username
        return GatewayConsumer(resource_name, opts=opts, __props__=__props__)
