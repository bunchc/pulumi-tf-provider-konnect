...
__all__ = [
    'GetGatewayPluginOpenidConnectResult',
    'AwaitableGetGatewayPluginOpenidConnectResult',
    'get_gateway_plugin_openid_connect',
    'get_gateway_plugin_openid_connect_output',
]

@pulumi.output_type
class GetGatewayPluginOpenidConnectResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginOpenidConnectConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginOpenidConnectConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginOpenidConnectConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginOpenidConnectRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginOpenidConnectServiceResult':
...
class AwaitableGetGatewayPluginOpenidConnectResult(GetGatewayPluginOpenidConnectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginOpenidConnectResult(
            config=self.config,
...
def get_gateway_plugin_openid_connect(control_plane_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginOpenidConnectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginOpenidConnect:getGatewayPluginOpenidConnect', __args__, opts=opts, typ=GetGatewayPluginOpenidConnectResult).value

    return AwaitableGetGatewayPluginOpenidConnectResult(
...
@_utilities.lift_output_func(get_gateway_plugin_openid_connect)
def get_gateway_plugin_openid_connect_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginOpenidConnectResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
