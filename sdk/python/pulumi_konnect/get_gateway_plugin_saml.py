...
__all__ = [
    'GetGatewayPluginSamlResult',
    'AwaitableGetGatewayPluginSamlResult',
    'get_gateway_plugin_saml',
    'get_gateway_plugin_saml_output',
]

@pulumi.output_type
class GetGatewayPluginSamlResult:
    """
    ...
    @property
    @pulumi.getter
    def config(self) -> 'outputs.GetGatewayPluginSamlConfigResult':
        return pulumi.get(self, "config")

    @property
    @pulumi.getter
    def consumer(self) -> 'outputs.GetGatewayPluginSamlConsumerResult':
        return pulumi.get(self, "consumer")

    @property
    @pulumi.getter(name="consumerGroup")
    def consumer_group(self) -> 'outputs.GetGatewayPluginSamlConsumerGroupResult':
    ...
    @property
    @pulumi.getter
    def route(self) -> 'outputs.GetGatewayPluginSamlRouteResult':
        return pulumi.get(self, "route")

    @property
    @pulumi.getter
    def service(self) -> 'outputs.GetGatewayPluginSamlServiceResult':
...
class AwaitableGetGatewayPluginSamlResult(GetGatewayPluginSamlResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayPluginSamlResult(
            config=self.config,
...
def get_gateway_plugin_saml(control_plane_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayPluginSamlResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('konnect:index/getGatewayPluginSaml:getGatewayPluginSaml', __args__, opts=opts, typ=GetGatewayPluginSamlResult).value

    return AwaitableGetGatewayPluginSamlResult(
...
@_utilities.lift_output_func(get_gateway_plugin_saml)
def get_gateway_plugin_saml_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayPluginSamlResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
